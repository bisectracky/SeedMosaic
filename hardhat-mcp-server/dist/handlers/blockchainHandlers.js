...
export class BlockchainHandlers {
    static async handleEthCall(args) {
...
`;
    ...
    static async handleEthSendTransaction(args) {
...
`;
    ...
    static async handleEthGetBalance(args) {
...
`;
    ...
    static async handleEthGetTransactionReceipt(args) {
...
`;
    ...
    static async handleInstallDependency(args) {
