...
export class ContractHandlers {
    static async handleCompile(args) {
    ...
    static async handleConsole(args) {
    ...
    static async handleRunScript(args) {
    ...
    static async handleFlatten(args) {
