...
export class FileHandlers {
    static async handleCreateContract(args) {
    ...
    static async handleCreateTest(args) {
    ...
    static async handleCreateIgnitionModule(args) {
    ...
    static async handleReadFile(args) {
        const { filePath } = args;
    ...
    static async handleListFiles(args) {
